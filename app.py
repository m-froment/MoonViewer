...
### Sidebar with data and location selector ===============================================================================================================
with st.sidebar:
...
with plot_tab:
    ...
    figshack, fig2, df_conditions =shackleton_visibility(datetime,forecast_days,[observer_lat,observer_lon])
    ...
    with col:
        ### Figure for visibility 
        st.pyplot(figshack, clear_figure=True)
    ### Plot best obseration conditions. 
    # with colplots:
...
### Second tab: Possibility to plot a 3D Moon render ===============================================================================================
with moon_tab:
